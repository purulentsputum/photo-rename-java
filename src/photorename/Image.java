...
public class Image {
   ...
   *   position. This method can also be used to create image mosiacs.
     * @param in
   */    
    public void addImage(photorename.Image in, int x, int y, boolean expand){ 
   ...
   */
    public boolean equals(Object obj){
        if (obj!=null){
            if (obj instanceof photorename.Image){
                photorename.Image image = (photorename.Image) obj;
   ...
   *  this:
   <pre>
    photorename.Image image = new photorename.Image("/temp/image.jpg");
...
private class Skew {
    ...
    public Skew(photorename.Image src) {
